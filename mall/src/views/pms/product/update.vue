...
<script>
  //引入商品分类和商品品牌
  import {fetchListWithChildren, fetchBrandList, createProduct,getProduct,getParentId,updateProduct } from '@/api/product';
  export default {
    name: 'updateProduct',
	data:function(){
		return {
	...
	watch: {
		 ...
		 selectProductCateValue: function (newValue) {
		   ...
		   if (newValue != null && newValue.length === 2) {
		     ...
		     this.productValue.product_category_name= this.getCateNameById(this.productValue.product_category_id);
		   } else {
		     this.productValue.product_category_id = null;
		     this.productValue.product_category_name=null;
		   }
		 }
	},
	methods:{
