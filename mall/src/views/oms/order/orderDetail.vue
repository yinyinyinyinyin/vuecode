  ...
  <div class="detail-container">
    <div>
      <el-steps :active="formatStepStatus(order.status)" finish-status="success" align-center>
        ...
        <el-step title="支付订单" :description="formatTime(order.payment_time)"></el-step>
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{order.member_username}}</el-col>
      ...
      <el-table
        ...
        <el-table-column label="属性" align="center">
          <template slot-scope="scope">
            {{scope.row.product_attr | formatProductAttr}}
          </template>
        </el-table-column>
      ...
      <el-table style="margin-top: 20px;width: 100%"
        ...
        <el-table-column label="订单状态"  width="120" align="center">
          <template slot-scope="scope">
            {{scope.row.order_status | formatStatus}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="发货状态"  width="120" align="center">
          <template slot-scope="scope">
            {{scope.row.order_status | formatDeliverStatus}}
          </template>
        </el-table-column>
    ...
    <el-dialog title="修改收货人信息"
      ...
      <el-form :model="receiverInfo"
        ...
        <el-form-item label="手机号码：">
          <el-input v-model="receiverInfo.receiver_phone" style="width: 200px">
          </el-input>
        </el-form-item>
        <el-form-item label="邮政编码：">
          <el-input v-model="receiverInfo.receiver_post_code" style="width: 200px">
          </el-input>
        </el-form-item>
        <el-form-item label="所在区域：">
          <v-distpicker :province="receiverInfo.receiver_province"
                        :city="receiverInfo.receiver_city"
                        :area="receiverInfo.receiver_region"
...
<script>
  import {getOrderDetail,updateReceiverInfo,updateOrderNote,closeOrder,deleteOrder} from '@/api/order';
  ...
  export default {
    ...
    methods: {
      onSelectRegion(data){
        ...
        this.receiverInfo.receiver_region=data.area.value;
      },
      formatTime(time) {
        if (time == null || time === '') {
          return '';
      ...
      showUpdateReceiverDialog(){
        ...
        this.receiverInfo={
          ...
          receiver_post_code:this.order.receiver_post_code,
          ...
          receiver_region:this.order.receiver_region,
